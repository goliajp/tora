...
import hello_server_pb2 as hello__server__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in hello_server_pb2_grpc.py depends on'
...
def add_ChatServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'tora.ChatService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('tora.ChatService', rpc_method_handlers)
